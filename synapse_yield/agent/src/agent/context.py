...
- Call `run_swarm(prompt="<user's full request>", preset_name="<explicit presets>")` when the user names a presets/team, e.g. `investment_committee`.
- If no presets is named, call `run_swarm(prompt="<user's full request>")` so it auto-selects the right presets.
